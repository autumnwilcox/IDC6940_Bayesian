...
-   Coefficients: Normal(0, 2.5), a weakly informative prior commonly recommended for logistic regression [@gelman2008].
...
-   Posterior sampling was performed using Stan’s No-U-Turn Sampler (NUTS) [@stan2020].
...
Data were obtained from the National Health and Nutrition Examination Survey (NHANES) 2013–2014 cycle [@nhanes2013].
