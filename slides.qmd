...
- **Data Source:** NHANES 2013–2014 (CDC/NCHS) [@nchs2014] 
...
4. **Bayesian Logistic Regression (brms)**  
   - Weakly informative priors (coefficients Normal(0, 2.5); intercept Student-t(3, 0, 10)) [@gelman2008]  
   - Four chains × 2000 iterations, `adapt_delta = 0.95` using NUTS [@hoffman2014nuts]  
