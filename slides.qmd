...
* **Coefficient prior: Normal(0, 2.5)** (Gelman, 2008)
  * Weakly informative  
  * Mean = 0, SD = 2.5  
...
* **Bulk ESS** → reliability of mean/median estimates

* **Tail ESS** → reliability of extreme quantiles (2.5%, 97.5%)
...
- **R-hat ≈ 1**  
- **Effective sample size ≈ 3500**, meaning the chain contains information equivalent to ~3,500 independent samples  
  - Reflects **good mixing**, **low autocorrelation**, and **highly reliable** posterior estimates

### Trace Plots (Stable Posteriors)

![](figs/mcmc_trace.png){fig-align="center" width="55%"}

### Density Plot

![](figs/prior_only_density.png){fig-align="center" width="55%"}
...
![](figs/posterior_prevalence_hist.png){fig-align="center" width="55%"}
...
**Overall, the model’s individual-level predictions align well with the observed data.**
...
This example evaluates the posterior predictive distribution for a  
**real participant from the dataset** (“Participant 1”) who has  
**lower-risk characteristics**.

- **Median predicted probability:** ~0.25  
- **95% Credible Interval:** ~0.20–0.31  

This demonstrates how the model estimates personalized diabetes risk  
for an individual with **moderate demographic and clinical risk factors**.
...
**hypothetical individual** with a **high-risk profile**:
...
![](figs/posterior_pred_dist.png){fig-align="center" width="55%"}
