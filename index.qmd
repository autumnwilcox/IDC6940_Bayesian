...
4.3% missing `BMI` and 3.1% missing diabetes diagnosis (`diabetes_dx`). All design variables (`WTMEC2YR`, `SDMVPSU`, `SDMVSTRA`), as well as `age`, `sex`, and `race`, are complete—sex and
