...
-   **Regression coefficients:** Normal(0, 2.5), providing gentle
    regularization while allowing substantial variation in plausible
    effects (van de Schoot et al., 2021).\
-   **Intercept:** Student’s t-distribution prior, Student_t(3, 0, 10),
    which has
...
-   **Posterior sampling:** Conducted via Markov Chain Monte
    ...
    Hamiltonian Monte Carlo (HMC) (Austin, 2021). Four chains were run
