...
to different modeling assumptions and missing-data treatments.
...
The Bayesian, survey-weighted, and multiple-imputation logistic
regression frameworks all identified consistent predictors of diabetes
risk among U.S. adults: advancing age, higher BMI, sex (lower odds for
females), and non-White race/ethnicity. These convergent findings
reinforce the robustness of core risk factors and the validity of the
analytic approach across modeling paradigms.
