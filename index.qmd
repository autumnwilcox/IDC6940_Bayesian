...
BMI and Age are standardized (mean 0, SD 1). Categorical predictors use Male and White as reference levels, and race/ethnicity is modeled with the coarsened three-level factor race3 (White, Black, Hispanic; rare/other levels lumped as “Other” as needed) to reduce sparsity and separation. All analyses respect NHANES design elements (PSU, strata, exam weights).
