...
```{r}
#| label: tbl-mice
#| tbl-cap: "Multiple Imputation (MICE): pooled odds ratios (OR) and 95% confidence intervals for diabetes diagnosis after imputing missing BMI (PMM) and using observed diabetes status (m = 5)."
knitr::kable(mi_or)
```
