...
For interpretability, age and BMI were standardized to mean 0 and SD 1 prior
to modeling; consequently, odds ratios for these predictors are reported per
one standard deviation (1 SD) increase in age and BMI across all models.
