...
#| message: false
#| warning: false
#| fig-cap: "The missingness plot shows minimal data loss across key variables, with only BMI-related fields (bmi, bmi_c, bmi_cat) missing in about 4.3% of records and diabetes_dx missing in 3.1%. All demographic and design variables are complete, indicating that missingness is concentrated in health-related measures and suitable for multiple imputation."
...
#| message: false
#| warning: false
#| fig-cap: "This table highlights missingness in the key analysis variables only, showing 249 missing values for BMI and 177 for diabetes diagnosis. While other variables are complete, these two were the focus for imputation due to their direct role in the modeling framework."
