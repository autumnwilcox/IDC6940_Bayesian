...
Bayesian $R^2$ values indicated that this compact covariate set explained a
meaningful portion of variability in diabetes risk.
...
labs(
  ...
  subtitle = "Posterior mean predictions from Bayesian model — Male, White (race3)",
