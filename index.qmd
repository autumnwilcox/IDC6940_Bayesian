...
Overall missingness in the analytic variables was low, with approximately
**3–4%** missing data in age or BMI. This level of missingness supported the use
of multiple imputation during data preparation and ensured that complete-case
analyses remained consistent for model comparison.
...
After applying exclusions and resolving the small amount of missingness
(≈3–4%), both the survey-weighted and Bayesian models were fit to the
same complete-case adult dataset (n = 5,769).
...
**8.9%**, whereas the Bayesian model’s posterior predictive mean
prevalence was also in the **8–9%** range. This close agreement
