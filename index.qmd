...
The combined dataset contained **n = 5,769 adults** after applying inclusion
criteria and preparing variables for analysis. The primary outcome was
**doctor-diagnosed diabetes** (`diabetes_dx`). Predictor variables included:
