  ...
  dplyr::mutate(
    ...
    bmi_cat = forcats::fct_explicit_na(bmi_cat, na_level = "(Missing)") |>
      forcats::fct_relevel(
        ...
        "Obesity I","Obesity II","Obesity III","(Missing)"
      ),
...
Missingness was low overall (~`r round(mean(is.na(adult_eda$bmi) | is.na(adult_eda$diabetes_ind)) * 100, 1)`%). Gaps were concentrated in `bmi` and `diabetes_ind`; design variables and demographics were complete. Patterns were consistent with MAR.
...
| **race4Hispanic** | 1.81 | <0.001 | Hispanic adults have ~81% higher odds of diabetes compared with Non-Hispanic Whites. |
| **race4Black** | 1.60 | 0.009 | Non-Hispanic Black adults have ~60% higher odds of diabetes compared with Non-Hispanic Whites. |
| **race4Other** | 2.20 | 0.002 | Adults identifying as Other/Multi-racial have more than 2× higher odds of diabetes compared with Non-Hispanic Whites. |
...
indicating reliable estimation of missing BMI and age values. After MICE,
