...
and Nutrition Examination Survey (NHANES). Predictors include age, body mass index (BMI), sex, and a coarsened race/ethnicity factor (`race3`) comprising White, Black, and Hispanic groups, with low-frequency levels combined as “Other.” The NHANES variable `race3` classifies participants into six categories: Mexican American, Other Hispanic, Non-Hispanic White, Non-Hispanic Black, Non-Hispanic Asian, and Other race (including multi-racial). For this analysis, these categories were collapsed into four groups—White, Black, Hispanic, and Other—to ensure adequate representation across groups and improve model stability.
